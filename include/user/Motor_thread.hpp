...
public:
    std::vector<SerialGroup> serialGroups = {
        {"/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT9ZWJXF-if03-port0", {0,5}},
        {"/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT9ZWJXF-if01-port0", {1,6}},
        {"/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT9ZWJXF-if00-port0", {2, 3, 4}},
        {"/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT9ZWJXF-if02-port0", {7, 8, 9}}
    };
    MotorController() {
